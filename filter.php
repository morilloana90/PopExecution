<?php
     ...
     {	   
      ...
      if (!empty($_POST['xbuscar'])) 
      {
          ...
          $where=" (CONCAT(Country,City,Store,Location,ProductGroup,Week_Route,channel,site_id) LIKE '%".$Buscador."%')  ";
       ...
       if (isset($_POST['Search']))
       {
        ...
        If (!empty($_POST['cbx_Location']))  {
          ...
          $where="site_id='".$Location."' and  Country='$Country'  ";  
          }
          elseif
          (!empty($_POST['cbx_Store']) and !empty($_POST['cbx_Country']))  {
          ...
          (!empty($_POST['cbx_City']) and !empty($_POST['cbx_Country']) and empty($_POST['cbx_Store'])  and empty($_POST['cbx_Location']) )  {
            $City=$_POST['cbx_City']; 
            $Country=$_POST['cbx_Country'];  
            $where=" CONCAT(Country,City) LIKE '%".$City."%' and  Country='$Country'  ";  
          }
          elseif
          (empty($_POST['cbx_City']) and !empty($_POST['cbx_Country']) and empty($_POST['cbx_Store'])  and empty($_POST['cbx_Location']) )  {
          ...
          if ((!empty($_POST['cbx_week'])) and empty($_POST['cbx_Country']) and empty($_POST['cbx_City']) and empty($_POST['cbx_Location']) 
          and  empty($_POST['cbx_ProductGroup']) and empty($_POST['cbx_Store']) ) 
          {
           $Week_Route=$_POST['cbx_week'];             
           $where=" Week_Route='$Week_Route'";
          } elseif ((!empty
          ($_POST['cbx_week'])) and (!empty($_POST['cbx_Country']) or !empty($_POST['cbx_City']) or !empty($_POST['cbx_Location']) 
          or !empty($_POST['cbx_Store']) )){
            $Week_Route=$_POST['cbx_week'];   
          ...
          if ((!empty($_POST['cbx_ProductGroup'])) and empty($_POST['cbx_Country']) and empty($_POST['cbx_City']) and empty($_POST['cbx_Location']) 
          and  empty($_POST['cbx_week']) and empty($_POST['cbx_Store']) and empty($_POST['cbx_Division']) )
          {
           $ProductGroup=$_POST['cbx_ProductGroup'];             
           $where=" ProductGroup='$ProductGroup'";
          } elseif ((!empty($_POST['cbx_ProductGroup'])) and (!empty($_POST['cbx_Country']) or !empty($_POST['cbx_City']) or !empty($_POST['cbx_Location']) 
          or !empty($_POST['cbx_Store']) or !empty($_POST['cbx_Division']))){
            $ProductGroup=$_POST['cbx_ProductGroup'];   
            $where=$where." and ProductGroup='$ProductGroup'";

          }

          if (( !empty($_POST['cbx_Division'])) and empty($_POST['cbx_ProductGroup']) and empty($_POST['cbx_Country']) and empty($_POST['cbx_City']) and empty($_POST['cbx_Location']) 
          and  empty($_POST['cbx_week']) and empty($_POST['cbx_Store']) ) 
          {
           $Division=$_POST['cbx_Division'];             
           $where=" Sub_Categoria='$Division'";

          } elseif (( !empty($_POST['cbx_Division'])) and ( !empty($_POST['cbx_ProductGroup']) or !empty($_POST['cbx_Country']) or !empty($_POST['cbx_City']) or !empty($_POST['cbx_Location']) 
          or !empty($_POST['cbx_Store']) ) ){
            $Division=$_POST['cbx_Division'];   
   ...
   $queryL = "SELECT distinct Location,site_id FROM AvengersPOPExcecution  ORDER BY Location";
